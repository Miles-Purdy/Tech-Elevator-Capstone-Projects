...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "user1@techelevator.com", "ROLE_USER");
    protected static final User USER_2 = new User(2, "user2", "user2", "user2@techelevator.com", "ROLE_USER");
    private static final User USER_3 = new User(3, "user3", "user3", "user3@techelevator.com","ROLE_USER");
    ...
    public void create_user_with_null_username() {
        sut.create(null, USER_3.getPassword(), USER_3.getEmailAddress(), "ROLE_USER");
    }

    @Test(expected = DataIntegrityViolationException.class)
    public void create_user_with_existing_username() {
        sut.create(USER_1.getUsername(), USER_3.getPassword(), USER_3.getEmailAddress(),"ROLE_USER");
    }

    @Test(expected = IllegalArgumentException.class)
    public void create_user_with_null_password() {
        sut.create(USER_3.getUsername(), null, USER_3.getEmailAddress(),"ROLE_USER");
    }
    ...
    public void create_user_creates_a_user() {
        ...
        boolean userWasCreated = sut.create(newUser.getUsername(), newUser.getPassword(), newUser.getEmailAddress(), "ROLE_USER");
